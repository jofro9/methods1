...
#' in statistics. Goodman also hints out how this may shape our thinking about the two common schools of 
#' thought in statistics, bayesian and frequentist statistics. For all intents and purposes, deductive 
#' reasoning implies that we assume something to be true in nature and then make a prediction about what 
...
#' about the real world. These to methods of reasoning lead us to two schools of thought in statistics, where 
#' in frequentist statistics we would use deductive reasoning, and in bayesian statistics we would use 
#' inductive reasoning.  
#'   
