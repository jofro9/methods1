...
The CLT states that as n gets large, we would expect the sample means to behave normally, however it appears with the cauchy distribution that no amount of increase to the sample size will cause this distribution to behave normally. For the previous problem it only took a sample size of (arguably) 30 to start to look normal.